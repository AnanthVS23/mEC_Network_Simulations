...
cfg.duration = 8*125          # Duration of the simulation, in ms
...
for_raster = [16,18,27,31,35,50,56,81,93,115,250,340,420]
offset = 0
...
#cfg.analysis['plotRaster'] = {'saveFig': True, 'timeRange': timeRange}                  # Plot a raster 'include': recordedCells2,
...
#cfg.analysis['plotTraces'] = {'include': for_raster,'saveFig': True, 'timeRange': timeRange}  # Plot recorded traces for this list of cells#'include': for_raster, 
...
cfg.Weight_E2I = 0.0005
#Weight_Cond = 0.0
cfg.Weight_I2E = 1.65
#cfg.NOISE_I_CLAMP = True
#cfg.NoiseAmp = 0.05*1e-3
...
cfg.GapJunctProb, cfg.ChemycalConnProb = 0.18, 0.3 # Probability connections from FS PV+ to FS PV+                          
                                                                          
cfg.ConnProbIE, cfg.ConnProbEI = 0.4, 0.3 # FS PV+ to SC and SC to FS PV+ probability connections          
...
cfg.NOISE=True # If true, adds a random fluctuating current simulating in-vivo like CORTEX noise. TODO: Adjust parameters for mEC region 
cfg.MeanENoise, cfg.MeanINoise, cfg.StdENoise, cfg.StdINoise = 0.0009, 0.0009, 0.00002, 0.00002                                             
cfg.I_sin=0   
