...
randomseed = 7894):
  ...
  try: 
    gLs = np.loadtxt("gLsRoman.dat")
    ELs = np.loadtxt("ELsRoman.dat")
    taums = FactorTau*np.loadtxt("taumsRomanUniform.dat")
    gNas, gKv3s, gKv7s, thm1s, thh2s, thn1s, tha1s = np.transpose(np.loadtxt( os.getcwd()+"params_actRoman.dat" ))
    ...
    gLs = np.loadtxt(os.getcwd()+"/SetupModels/gLsRoman.dat")
    ELs = np.loadtxt(os.getcwd()+"/SetupModels/ELsRoman.dat")
    taums = FactorTau*np.loadtxt(os.getcwd()+"/SetupModels/taumsRomanUniform.dat")
    gNas, gKv3s, gKv7s, thm1s, thh2s, thn1s, tha1s = np.transpose(np.loadtxt(os.getcwd()+"/SetupModels/params_actRoman.dat" ))
