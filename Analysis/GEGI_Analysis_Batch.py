...
for file in glob.glob("../1110_Swami/*_data.pkl"):#Modify based on te folder
...
print(power_array)
np.savetxt(FileID+'GEGI_Batch_Data.txt', power_array, fmt="%.2f", delimiter=",")
np.savetxt(FileID+'GEGI_Batch_Data.csv',power_array, fmt="%.2f", delimiter=",")
