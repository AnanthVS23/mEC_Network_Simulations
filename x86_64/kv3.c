...
#define thn1 _p[1]
#define thn1_columnindex 1
#define sign1 _p[2]
#define sign1_columnindex 2
#define kn2 _p[3]
#define kn2_columnindex 3
#define kn1 _p[4]
#define kn1_columnindex 4
#define sign2 _p[5]
#define sign2_columnindex 5
#define n _p[6]
#define n_columnindex 6
#define ik _p[7]
#define ik_columnindex 7
#define thegk _p[8]
#define thegk_columnindex 8
#define alphan _p[9]
#define alphan_columnindex 9
#define betan _p[10]
#define betan_columnindex 10
#define Dn _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv3 /mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/kv3.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Kv3";
...
static int  trates ( _threadargsprotocomma_ double _lvm ) {
   alphan = - kn1 * ( v - thn1 ) / ( exp ( - ( v - thn1 ) / sign1 ) - 1.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/kv3.mod";
static const char* nmodl_file_text = 
  "TITLE Kv3\n"
  "\n"
  "NEURON {\n"
