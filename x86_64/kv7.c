...
#define tha1 _p[1]
#define tha1_columnindex 1
#define siga1 _p[2]
#define siga1_columnindex 2
#define ka2 _p[3]
#define ka2_columnindex 3
#define ka1 _p[4]
#define ka1_columnindex 4
#define a _p[5]
#define a_columnindex 5
#define ik _p[6]
#define ik_columnindex 6
#define thegk _p[7]
#define thegk_columnindex 7
#define alphaa _p[8]
#define alphaa_columnindex 8
#define betaa _p[9]
#define betaa_columnindex 9
#define Da _p[10]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "trates_kv7", _hoc_trates,
 0, 0
};
 /* declare global and static user variables */
#define ek ek_kv7
 double ek = -90;
#define siga2 siga2_kv7
 double siga2 = -80;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv7 /mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/kv7.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Kv1";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {int _reset = 0; {
   ...
   Da = alphaa * ( 1.0 - a ) - betaa * a ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
 trates ( _threadargscomma_ v ) ;
 Da = Da  / (1. - dt*( ( alphaa )*( ( ( - 1.0 ) ) ) - ( betaa )*( 1.0 ) )) ;
  return 0;
}
 /*END CVODE*/
...
static int  trates ( _threadargsprotocomma_ double _lvm ) {
   alphaa = - ka1 * ( v - tha1 ) / ( exp ( - ( v - tha1 ) / siga1 ) - 1.0 ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/kv7.mod";
static const char* nmodl_file_text = 
  "TITLE Kv1\n"
  "\n"
  "NEURON {\n"
