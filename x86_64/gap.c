...
#define nrn_init _nrn_init__ElectSyn
#define _nrn_initial _nrn_initial__ElectSyn
#define nrn_cur _nrn_cur__ElectSyn
#define _nrn_current _nrn_current__ElectSyn
#define nrn_jacob _nrn_jacob__ElectSyn
#define nrn_state _nrn_state__ElectSyn
#define _net_receive _net_receive__ElectSyn 
...
#define dt _nt->_dt
#define vpeer _p[0]
#define vpeer_columnindex 0
#define g _p[1]
#define g_columnindex 1
#define weight _p[2]
#define weight_columnindex 2
#define i _p[3]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 ElectSyn /mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/gap.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: ElectSyn";
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/gap.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "   **************************************************\n"
