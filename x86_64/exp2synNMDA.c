...
#define nonlinear _p[3]
#define nonlinear_columnindex 3
#define vshiftmg _p[4]
#define vshiftmg_columnindex 4
#define i _p[5]
#define i_columnindex 5
#define g _p[6]
#define g_columnindex 6
#define pnmda _p[7]
#define pnmda_columnindex 7
#define A _p[8]
...
#define usetable usetable_Exp2SynNMDA
 double usetable = 1;
#define vRestNL vRestNL_Exp2SynNMDA
 double vRestNL = -60;
 ...
 "vRestNL_Exp2SynNMDA", &vRestNL_Exp2SynNMDA,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Exp2SynNMDA /mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/exp2synNMDA.mod\n");
...
double _f_mgblock ( _threadargsprotocomma_ double _lv ) {
   double _lmgblock;
 _lmgblock = 1.0 / ( 1.0 + exp ( 0.062 * - ( _lv + vshiftmg ) ) * ( mg / 3.57 ) ) ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   g = B - A ;
   if ( nonlinear  != 0.0 ) {
     pnmda = mgblock ( _threadargscomma_ v ) ;
     }
   else {
     pnmda = mgblock ( _threadargscomma_ vRestNL ) ;
     }
   i = g * pnmda * ( v - e ) ;
   }
 _current += i;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/mnt/beegfs/home/avedur/NetPyNe_Sims/Automated/mEC_Network_Simulations/mod/exp2synNMDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
